...
'''
Plot POSMV heading accuracy for a UHDAS directory structure
usage:

   plot_posmv.py [options]  /home/data/km1103/gbin/heading/km_2011_123*.hbin
   plot_posmv.py [options]  /home/data/km1103/gbin/heading
   plot_posmv.py [options]  /home/data/km1103/gbin/
   plot_posmv.py [options]  /home/data/km1103


NOTE: program subsamples by 30 for speed; use all points by saying

   plot_posmv.py -s1  /home/data/km1103
...
from pycurrents.adcp.plot_posmv_subs import get_filelist, plot_posmv
...
if __name__ == '__main__':
    ...
    parser.add_option("--start", dest="start",
                      default = 0,
                      help="start at index START (default = 0, i.e. the beginning)")
    parser.add_option("--stop", dest="stop",
                      default = None,
                      help="start at index STOP (default = -1, i.e. the end)")

    parser.add_option("--cutoff", dest="cutoff",
                      default = 0.02,
               help="cutoff to accept heading accuracy (exceeds is bad). default=0.2")
